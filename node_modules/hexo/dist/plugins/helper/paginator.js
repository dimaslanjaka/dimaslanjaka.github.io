...
const createLink = (options, ctx) => {
    ...
    return i => hexo_util_1.url_for.call(ctx, i === 1 ? base : base + format.replace('%d', i));
};
const createPageTag = (options, ctx) => {
    ...
    return i => {
        if (i === current) {
            return (0, hexo_util_1.htmlTag)('span', { class: pageClass + ' ' + currentClass }, transform ? transform(i) : i, escape);
        }
        return (0, hexo_util_1.htmlTag)('a', { class: pageClass, href: link(i) }, transform ? transform(i) : i, escape);
    };
};
