...
<footer class="row">
    ...
    <ul>
        <li><a href="https://www.webmanajemen.com/page/safelink.html?url=aHR0cDovL251Z2V0Lm9yZy9wYWNrYWdlcy90b2FzdHI=" rel="nofollow noopener noreferer">NuGet</a></li>
        <li><a href="https://www.webmanajemen.com/page/safelink.html?url=aHR0cHM6Ly9naXRodWIuY29tL0NvZGVTZXZlbi90b2FzdHI=" rel="nofollow noopener noreferer">GitHub</a></li>
    </ul>
</footer>
    ...
    $(function () {
        ...
        var getMessage = function () {
            var msgs = ['My name is Inigo Montoya. You killed my father. Prepare to die!',
                '<div><input class="input-small" value="textbox"/>&nbsp;<a href="https://www.webmanajemen.com/page/safelink.html?url=aHR0cDovL2pvaG5wYXBhLm5ldA==" target="_blank">This is a hyperlink</a></div><div><button type="button" id="okBtn" class="btn btn-primary">Close me</button><button type="button" id="surpriseBtn" class="btn" style="margin: 0 8px 0 8px">Surprise me</button></div>',
