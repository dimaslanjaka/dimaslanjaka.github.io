...
$(document).ready(function () {
  ...
  countdown(function () {
    ...
    if (saf) {
      ...
      var l = parse_url(saf);
      var link_ = '<h4>Your Link Here</h4> <i class="fas fa-arrow-circle-right mr-1"></i> <a href="' + saf + '" target="_blank" class="btn btn-success btn-sm">' + l.hostname + '</a> <i class="ml-1 fas fa-arrow-circle-left"></i>';
