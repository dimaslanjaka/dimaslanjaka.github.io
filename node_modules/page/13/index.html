...
<div class="post-block">
  ...
  <article itemscope itemtype="http://schema.org/Article" class="post-content" lang="en">
    ...
    <div class="post-body" itemprop="articleBody">
          <p>h2>Contribution Tutorial</h2><ol> <li>Fork it git clone https://github.com/name/repo</li> <li>Create your feature branch git checkout</p>
          <!--noindex-->
            <div class="post-button">
...
<div class="post-block">
  ...
  <article itemscope itemtype="http://schema.org/Article" class="post-content" lang="en">
    ...
    <div class="post-body" itemprop="articleBody">
          <p>pre><br />Usage: var_dumpget_client_ip;<br /></pre> <pre><br />/<br /> Detect is localhost<br /> <br /> @return boolean<br /></p>
          <!--noindex-->
            <div class="post-button">
...
<div class="post-block">
  ...
  <article itemscope itemtype="http://schema.org/Article" class="post-content" lang="en">
    ...
    <div class="post-body" itemprop="articleBody">
          <p>Calculate Swatch Internet Time Codes - WMI</p>
          <!--noindex-->
            <div class="post-button">
