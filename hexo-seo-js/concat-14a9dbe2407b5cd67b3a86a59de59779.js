...
var disqus_config = function () { this.page.url = 'https://www.webmanajemen.com/2022/03/git-add-existing-local-repository-folder-to-submodule.html'; this.page.identifier = 'dimaslanjaka'; this.page.title = document.title; };
